...
//class for declaring every received movie attributes
public class MovieItem {
    ...
    public MovieItem(String movie_title, String movie_picture, String movie_rating, String movie_overview, String movie_release_date) {
